        ...
        <div className="absolute right-0 mt-2 w-52 bg-[#FFFFFF] border border-[#E2E8F0] rounded-xl shadow-2xl py-1.5 z-50 animate-fade-in">
          ...
          <div className="p-1">
            <button
              ...
              className="w-full text-left px-3 py-2 text-xs font-semibold text-red-500 hover:bg-red-50 hover:text-red-600 rounded-lg flex items-center gap-2 transition-colors"
            >
